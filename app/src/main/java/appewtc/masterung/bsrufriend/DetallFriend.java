...
public class DetallFriend extends AppCompatActivity {
    //Explicit
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detall_friend2);
        ...
        Picasso.with(DetallFriend.this).load(getIntent()
                .getStringExtra("Image")).into(imageView);
        //button controler
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (ActivityCompat.checkSelfPermission(DetallFriend.this, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
